...
export default function YouTubePage() {
  ...
  const checkYouTubeStatus = async () => {
    ...
    try {
      const response = await apiClient.get<YouTubeStatus>("/youtube/status", token)
  ...
  const fetchChannelInfo = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await apiClient.get<{ channel: ChannelInfo }>("/youtube/channel", token)
  ...
  const connectYouTube = async () => {
    ...
    try {
      const response = await apiClient.get<{ authUrl: string }>("/youtube/auth-url", token)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Please log in to access YouTube settings</h1>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your YouTube channel connection and publishing settings</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="shadow-lg bg-white/80 backdrop-blur-sm border-0">
              <CardHeader>
                ...
                <CardDescription>Your YouTube channel connection and authentication status</CardDescription>
              </CardHeader>
              <CardContent>
                {youtubeStatus.connected ? (
                    ...
                    <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl border border-green-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">Your YouTube channel is connected and ready</p>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-gray-50 rounded-xl">
                        <div className="flex items-center space-x-4">
                          <Avatar className="w-16 h-16">
                            <AvatarImage src={channelInfo.thumbnail || "/placeholder.svg"} alt={channelInfo.title} />
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 line-clamp-2">{channelInfo.description}</p>
                            <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500">
                              <span className="flex items-center">
                                <Users className="w-4 h-4 mr-1" />
                                {Number.parseInt(channelInfo.subscriberCount).toLocaleString()} subscribers
                              </span>
                              <span className="flex items-center">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-6 max-w-md mx-auto">
                      Connect your YouTube channel to automatically publish approved videos and manage your content.
                    </p>
                    <Button
            ...
            {youtubeStatus.connected && channelInfo && (
              <Card className="shadow-lg bg-white/80 backdrop-blur-sm border-0">
                <CardHeader>
                  ...
                  <CardDescription>Overview of your YouTube channel performance</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-4 bg-blue-50 rounded-xl">
                      ...
                      <p className="text-2xl font-bold text-blue-900">
                        {Number.parseInt(channelInfo.viewCount).toLocaleString()}
                      </p>
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-xl">
                      ...
                      <p className="text-2xl font-bold text-green-900">
                        {Number.parseInt(channelInfo.subscriberCount).toLocaleString()}
                      </p>
                    ...
                    <div className="text-center p-4 bg-purple-50 rounded-xl">
                      ...
                      <p className="text-2xl font-bold text-purple-900">
                        {Number.parseInt(channelInfo.videoCount).toLocaleString()}
                      </p>
            ...
            <Card className="shadow-lg bg-white/80 backdrop-blur-sm border-0">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Videos published</span>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 text-sm">
                    ...
                    <span className="text-gray-600">Video published successfully</span>
                  </div>
                  <div className="flex items-center space-x-3 text-sm">
                  ...
                  <div className="flex items-center space-x-3 text-sm">
                    ...
                    <span className="text-gray-600">Pending video approval</span>
                  </div>
                </div>
              </CardContent>
            </Card>

...
export default function VideoReviewPage() {
  ...
  return (
    <>
      <MainNav />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 scrollbar-hidden">
        <div className="max-w-7xl mx-auto px-4 py-6 scrollbar-hidden">
          {/* Header */}
          ...
          {/* Main Content Grid */}
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 h-[calc(100vh-200px)] scrollbar-hidden ">
